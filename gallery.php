...
<body id='gallery' class="nojs">
  ...
  <div id="container">
    ...
    <div id="main" role="main">
		<ul id='gal_carousel'>
			...
			<li class='current'><a href='#'><img src='./img/tb_img5.jpg' alt='thumb_3' /></a></li>
			<li><a href='#'><img src='./img/tb_img3.jpg' alt='thumb_4' /></a></li>
			<li><a href='#'><img src='./img/tb_img4.jpg' alt='thumb_5' /></a></li>
		</ul>
		
		<img id='gal_image' src='./img/img5.jpg' alt='Gallery Image'/>
    </div>
    <footer>
  ...
  <script>window.jQuery || document.write('<script src="js/libs/jquery-1.5.1.min.js">\x3C/script>')</script>
	...
	<script type="text/javascript" src="js/ceFitImage.js"></script>
	
	<script>
		$(function(){
			$('body').removeClass('nojs');
			$('header').ce_menu();
			$('#gal_image').ce_fit_img();
			var ce_menu = $('header').data('ce_menu');
			$('.logo a').bind('click',function(){
				ce_menu.toggleHideMenu();
				return false;
			});
